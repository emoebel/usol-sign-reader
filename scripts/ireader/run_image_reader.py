...
fname_list = [
    #'48159-1_2.jpg', # destination, duration = line.split(':') ValueError: not enough values to unpack (expected 2, got 1)
    #'48618-1_2.jpg', # done
    #'48930-1_1.jpg', # destination, duration = line.split(':') ValueError: not enough values to unpack (expected 2, got 1)
    #'91712-1_1.jpg', # destination, duration = line.split(':') ValueError: not enough values to unpack (expected 2, got 1)
    '118098-1_3.jpg',
    '125146-2_2.jpg',
    '125279-1_1.jpg',
    '125321-1_4.jpg',
